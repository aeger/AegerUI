local AUI, aui = ...
 function aegerUI_BuffFrame:OnEnable() 
  --get the config values
  local cfg = aegerUI.db.global
  local dragFrameList = aegerUI.db.global.BuffFrame.dragFrameList
  ...
  if cfg.BuffFrame.adjustOneletterAbbrev then
  ...
  local function applySkin(b)
    ...
    local cfg, backdrop
    if debuff then
      cfg = aegerUI.db.global.DeBuffFrame
      backdrop = backdropDebuff
    else
      cfg = aegerUI.db.global.BuffFrame
  ...
  ConsolidatedBuffsTooltip:SetScale(cfg.BuffFrame.consolidatedTooltipScale)
