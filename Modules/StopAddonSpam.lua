...
local StopAddonSpam = aegerUI:NewModule("StopAddonSpam", "AceEvent-3.0", "AceHook-3.0")
...
StopAddonSpam.ruleset = {
	...
	rules = {
		...
		["GlyphReporter"] = {
			test = function (msg, id, frame) return string.find(string.lower(msg), string.lower("Glyph Reporter")) end,
			action = DENY
		},
		["askmrrobot"] = {
