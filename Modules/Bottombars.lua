...
function BottomBarFrame1()  
	     ...
	     Bar1texture:SetTexture(MEDIA_PATH .. "btrounded")		
		 ...
		 Bar1border:SetTexture(MEDIA_PATH .. "btroundedborder")
...
function BottomBarFrame2()  
	     ...
	     Bar2texture:SetTexture(MEDIA_PATH .. "btrounded")		
		 ...
		 Bar2border:SetTexture(MEDIA_PATH .. "btroundedborder")
