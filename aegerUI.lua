...
BottomBarFrame1:SetScript("OnShow", function(self)
	...
	Bar1display:SetTexture(MEDIA_PATH .. "btrounded")
...
Bar1BorderFrame:SetScript("OnShow", function(self)
	...
	Bar1tex:SetSize(947, 50)
	Bar1tex:SetPoint("BOTTOM", UIParent, "BOTTOM", 0, -6)
	Bar1tex:SetPoint("CENTER", UIParent, "CENTER")
	Bar1tex:SetTexture(MEDIA_PATH .. "btroundedborder")
...
BottomBarFrame2:SetScript("OnShow", function(self)
	...
	Bar2display:SetPoint("BOTTOM", UIParent, "BOTTOM", 0, -5)
	Bar2display:SetPoint("CENTER", UIParent, "CENTER")
	Bar2display:SetTexture(MEDIA_PATH .. "btrounded")
...
Bar2BorderFrame:SetScript("OnShow", function(self)
	...
	Bar2tex:SetSize(950, 94)
	Bar2tex:SetPoint("BOTTOM", UIParent, "BOTTOM", 0, -8)
	Bar2tex:SetPoint("CENTER", UIParent, "CENTER")
	Bar2tex:SetTexture(MEDIA_PATH .. "btroundedborder")
